...
Buttons have been taken out of the project.py file mainly because the intructor did it in the video I was watching. I do realized I could put it back in and nothing would change, but I do like how there's one less class within the main file. It also makes it very easy to know that if I need to change anything related to the buttons (like a sound effect) then that needs to be done within the button module. Overall kind of useless to have it seperated but I think the separation is nice... also makes it feel a bit more professional though I doubt it truly is.
...
The program itself is really simple with one core function (select a random color out of a list) but that was intentional. It may be under scope in comparison to my original proposal, but I felt like a lot of the complexity came from the way that I ended up presenting the color through the animations, transitions, and audio. Even if it is under scope I can at least say that I had a lot of fun making it, and that I learned a lot from this experience.